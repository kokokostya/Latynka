const SOURCE_TEMPLATES = {
  ...
  "geo" : {
    "name" : "Географія",
    "text" : "Київ, Алушта, Біла Церква, Вінниця, Гадяч, Ґорґани, Донецьк, Есмань, Знам'янка, Житомир, Йосипівка, Мар'їне, Миколаїв, Ніжин, Стрий, Ужгород, Харків, Шостка, Варшава, Гельсінкі, Нью-Йорк\n\nЗакарпаття, Сумщина, Україна, Русь, Московія, Азія, Європа, Бразилія, Гренландія, Китай, Німеччина, Північна Корея, Польща, США, Таджикістан, Угорщина, Фінляндія, Швеція, Чехія, Японія"
  },
