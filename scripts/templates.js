const SOURCE_TEMPLATES = {
  ...
  "geo" : {
    "name" : "Географія",
    "text" : "Київ, Алушта, Біла Церква, Вінниця, Гадяч, Ґорґани, Донецьк, Есмань, Знам'янка, Житомир, Йосипівка, Кадиївка, Короп'є, Мар'їне, Миколаїв, Ніжин, Рівне, Стрий, Ужгород, Харків, Шостка, Яготин\n\nЗакарпаття, Сумщина, Україна, Русь, Московія, Азія, Європа, Бразилія, Гренландія, Китай, Німеччина, Північна Корея, Польща, США, Таджикістан, Туреччина, Угорщина, Фінляндія, Швеція, Чехія, Японія"
  },
