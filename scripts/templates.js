const SOURCE_TEMPLATES = {
  ...
  "mix" : {
    "name" : "Всячина",
    "isEssential" : true,
    "text" : "Україна, Київ, Шевченко, Юрій, гривня, шахтар, валянок, тривіальний, м'ясо, з’їзд, кальян, Касьяненко, синяя, йогурт, всього, бульйон, бойовий, нижній, Кий, мить, Индик, говорити, узгодження, щороку, чіпляєшся, Юлія, Нью-Йорк, Стокгольм, полювання, цілуватись, киця, здається, подружжя"
  },

  "names" : {
    "name" : "Імена",
    "isEssential" : true,
    "text" : "Анастасія, Андрій, Аскольд, Богдан, Володимир, Дмитро, Жанна, Наталія, Олег, Олексій, Пєтька, Соломія, Уляна, Христина, Юлія, Юрій\n\nБєляєва, Вишневецька, Гаєвич, Ґалаґан, Згуровський, Маринич, Микитась, Онищенко, Рибчинська, Стеценко, Чапаєв, Шпольський, Ярошенко"
  },
